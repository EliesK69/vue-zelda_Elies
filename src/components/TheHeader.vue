        ...
        <div class="container">
            <div class="wrapper p-3 py-5 p-lg-5">
                ...
                <div class="row justify-content-center justify-content-lg-start mt-4">
                    <div class="col-12 col-md-6">
                        <h2 class="mbr-section-subtitle mbr-fonts-style pb-3 display-5"><strong>Plongez dans un monde de découverte, d'exploration et d'aventure. (Et oui, il faut ENCORE sauver Zelda...)</strong></h2>
                    </div>
                    <div class="col-12 col-md-6 d-flex">
                        <div class="mbr-section-btn">
                            <RouterLink to="/monster" class="btn btn-primary display-7">LES MONSTRES</RouterLink>
                            </div>
                        <div class="decor">
                            <svg viewBox="0 0 1 1">
